...
<div :style='{"border":"1px solid #dfdfdf","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="挂号编号" prop="guahaobianhao">
            <el-input v-model="ruleForm.guahaobianhao" 
                placeholder="挂号编号" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}'  label="项目名称" prop="xiangmumingcheng">
            <el-select v-model="ruleForm.xiangmumingcheng" placeholder="请选择项目名称"  multiple>
              <el-option
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="检查时间" prop="jianchashijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="就诊卡号" prop="jiuzhenkahao">
            <el-input v-model="ruleForm.jiuzhenkahao" 
                placeholder="就诊卡号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="用户金额" prop="yonghujine">
            <el-input v-model="ruleForm.yonghujine" 
                placeholder="用户金额" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='yonghujine'){
              this.ruleForm.yonghujine = obj[o];
              this.ro.yonghujine = true;
              continue;
            }
          }
        }
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.zhiwei!=''&&json.zhiwei) || json.zhiwei==0){
            ...
            if((json.jiuzhenkahao!=''&&json.jiuzhenkahao) || json.jiuzhenkahao==0){
                this.ruleForm.jiuzhenkahao = json.jiuzhenkahao
            }
            if((json.jine!=''&&json.jine) || json.jine==0){
                this.ruleForm.yonghujine = json.jine
            }
          }
        });
        this.$http.get('option/xiangmumingcheng/xiangmumingcheng', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.xiangmumingchengOptions = res.data.data;
          }
        });
      },
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('yuyuetijian/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.ruleForm = res.data.data;
            this.ruleForm.xiangmumingcheng = this.ruleForm.xiangmumingcheng.split(",");
          }
        });
      },
      // 提交
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.ruleForm.xiangmumingcheng = this.ruleForm.xiangmumingcheng.join(",");
                          this.$http.post('yuyuetijian/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
